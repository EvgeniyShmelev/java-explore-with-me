...
CREATE TABLE IF NOT EXISTS user_friends -- новая таблица для фичи
(
...
(
    ...
    status       VARCHAR(32)                             NOT NULL, -- может сделать ENUM?
...
(
    id     BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    pinned BOOLEAN                            DEFAULT FALSE, --(закреплено) изменить в pdf
...
(
    id                 BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    annotation         VARCHAR(2000)                           NOT NULL, --добавить в pdf
    ...
    loc_lat            FLOAT                                   NOT NULL, -- вместо отдельной таблицы
    loc_lon            FLOAT                                   NOT NULL, -- локаций. Внести в pdf
    paid               BOOLEAN                            DEFAULT FALSE, -- внести в пдф
    participant_limit  INT                                     NOT NULL,
    published_on       TIMESTAMP WITHOUT TIME ZONE,
    request_moderation BOOLEAN                                 NOT NULL,
    state              event_state                                     , -- вместо табл. state.
